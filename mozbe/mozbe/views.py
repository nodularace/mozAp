...
def api_root(request, format=None):
    return Response({
        ...
        ' AREA Batch operations: post/put/del - ': reverse('batch-operate-providers', request=request, format=format),
        ' PROVIDER Batch operations: post/put/del - ': reverse('batch-operate-areas', request=request, format=format),
    })
